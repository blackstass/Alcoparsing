...
После того как мы успешно собрали датасет, было время погрузиться в [анализ данных](https://github.com/blackstass/Data-Toscana/blob/main/АлкоАнализ_2.0.ipynb). Этот этап оказался испытанием, с которым мы столкнулись с некоторыми сложностями.
